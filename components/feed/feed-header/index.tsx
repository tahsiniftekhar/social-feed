...
export default function FeedHeader({ user, isDarkMode, toggleDarkMode }: FeedHeaderProps) {
  return (
    <>
      {/* Mode switching button (light/dark mode toggle) */}
      <div className="_layout_mode_swithing_btn">
        <button type="button" className="_layout_swithing_btn_link" onClick={toggleDarkMode}>
          <div className="_layout_swithing_btn">
            <div className={`_layout_swithing_btn_round ${isDarkMode ? "_layout_swithing_btn_round_active" : ""}`} />
          </div>
        ...
        <div className="container _custom_container">
          <div className="_logo_wrap">
            <Link className="navbar-brand" href="/feed">
              <Image src="/assets/images/logo.svg" alt="Logo" width={158} height={33} className="_nav_logo" unoptimized />
            </Link>
          </div>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8" style={{ listStyle: "none" }}>

...
export default function ProfileDropdown({ user }: ProfileDropdownProps) {
  ...
  const displayName = user ? `${user.firstName} ${user.lastName}` : "Dylan Field";
  ...
  return (
    <div className="_header_nav_profile" style={{ position: "relative" }}>
      <div className="_header_nav_profile_image" onClick={() => setIsOpen(!isOpen)} style={{ cursor: "pointer" }}>
        <Image
      ...
      <div className="_header_nav_dropdown" onClick={() => setIsOpen(!isOpen)} style={{ cursor: "pointer" }}>
      ...
      >
        <div className="_nav_profile_dropdown_info">
          ...
          <div className="_nav_profile_dropdown_info_txt">
            ...
            <span className="_nav_drop_profile" style={{ cursor: "pointer" }}>
              View Profile
            </span>
          </div>
        </div>
        <hr />
        <ul className="_nav_dropdown_list" style={{ paddingLeft: 0, margin: 0, listStyle: "none" }}>
          <li className="_nav_dropdown_list_item">
            <span className="_nav_dropdown_link" style={{ cursor: "pointer" }}>

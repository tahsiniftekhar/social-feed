        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-12 col-lg-12 col-md-12">
              <ul className="_mobile_navigation_bottom_list" style={{ listStyle: "none", paddingLeft: 0, margin: 0 }}>
                ...
                <li className="_mobile_navigation_bottom_item">
                  <Link href="/feed" className="_mobile_navigation_bottom_link">
                ...
                <div className="_header_mobile_toggle">
                  <span className="_header_mobile_btn_link" style={{ cursor: "pointer" }}>
